      ...
      <div class="col-6 text-center border rounded-lg mt-5 bg-light">
        ...
        <form @submit.prevent="login">
          <div class="input-group mb-2">
            ...
            <input type="email" v-model="email" id="email" placeholder="E-mail" class=" form-control">
          </div>
          <div class="input-group mb-2"> 
            <div class="input-group-prepend">
              <div class="input-group-text">
            ...
            <input type="password" v-model="password" id="password" placeholder="Contraseña" class=" form-control">
          </div>
          <div v-if="error">
          ...
          <div class="text-right text-secondary">
            <h6><small>
              o <a href="/Registro" class="text-secondary">registrate aquí</a>
            </small></h6>
          </div>
